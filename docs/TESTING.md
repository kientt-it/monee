...
Vitest được cấu hình bằng `npm run test`. Hiện có 27 tests cho balance effects, profile/account/goal schemas, report periods và lịch khoản vay (cuối tháng, năm nhuận, quá hạn, lưu trữ, kỳ đã đóng, ngày Việt Nam, validation).
