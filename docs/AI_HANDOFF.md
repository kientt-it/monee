...
Version 0.19.0. Foundation, onboarding/profile, Accounts, Transactions, Budgets, Reports, Saving Goals và Notifications MVP core đã có bằng Next.js App Router + TypeScript strict + Tailwind. Supabase dev đã được kết nối; dashboard trong khu vực đăng nhập đọc dữ liệu thật.
...
- Mobile có mục “Khác” trong bottom navigation để truy cập trực tiếp các màn Tài khoản, Ngân sách, Mục tiêu, Thông báo và Cá nhân.
...
- `/app/transactions/[id]` và `/edit` đã có detail/edit/soft-delete. Migration thứ hai thêm update/delete/restore RPC và revoke direct writes. 24 tests đang pass.
...
## Recently completed
2026-09-09: Gỡ recurring scheduler/cron khỏi sản phẩm và tối ưu chuyển tab; giữ route cũ dưới dạng redirect.
