...
Version 0.16.0. Foundation, onboarding/profile, Accounts, Transactions, Budgets, Reports, Saving Goals, Recurring và Notifications MVP core đã có bằng Next.js App Router + TypeScript strict + Tailwind. Supabase dev đã được kết nối; dashboard trong khu vực đăng nhập đọc dữ liệu thật.
