...
## Current status
Version 0.10.0. Supabase project đã được kết nối, ba migration đã có và endpoint Auth đã được xác minh phản hồi. Foundation, onboarding/profile, Accounts create/edit/archive/restore, Transactions create/edit/soft-delete, dashboard đọc dữ liệu thật, Budgets CRUD/progress, Reports theo kỳ, Saving Goals/contributions, Recurring management và Notifications đã có; financial balance effects được kiểm thử tự động.
