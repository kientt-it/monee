...
## Current status
Version 0.1.0. Phase 0–1 foundation đã có: mobile-first dashboard preview, auth routes, Supabase SSR clients, middleware, PWA shell và migration nền tảng. Chưa kết nối project Supabase cụ thể và chưa bật mutation giao dịch trong UI.
