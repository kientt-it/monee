...
## Current status
Version 0.4.0. Supabase project đã được kết nối, hai migration đã được người dùng apply và endpoint Auth đã được xác minh phản hồi. Foundation, Accounts, Transactions create/edit/soft-delete và dashboard đọc dữ liệu thật đã có; financial balance effects được kiểm thử tự động.
